...
export default function ExhibitionListItem(props: ListItemProps) {
    ...
    return (
        ...
        >
            <h3 className={css({ fontFamily: 'azeretMono', fontStyle: 'italic', fontWeight: '400', fontVariantNumeric: 'slashed-zero' })}>
                {exhibition?.title}
            </h3>
            {exhibition.venue && (
            ...
            {exhibition.startDate && exhibition.endDate && (
                <h3 className={css({ fontFamily: 'azeretMono', fontStyle: 'normal', fontVariantNumeric: 'slashed-zero' })}>
